...
server = function(input, output, session) {
  ...
  # Load Expression from Github Data and UMAP ---------------------------------
  loadExprData <- function(path_expr, path_freq) {
  ...
  observeEvent(input$btnLoadDemoData, {
    ...
    loadExprData(dataPath$url_median_expr, dataPath$url_cluster_freq)
    
    initExprData()
  })
  
  # Retrieve the demo data path -----------------------------------------------
  getDataPath <- function() {
    
    list(
      url_median_expr="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/median_expr_1600.csv",
      url_cluster_freq="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/cluster_freq_1600.csv",
      url_thresholds="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/MarkerThresholds.csv",
      url_metadata="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/metadata.csv",
      url_cluster_counts="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/cluster_counts_1600.csv",
      url_nodes_table="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/nodesTable_data.csv",
      url_edges_table="https://raw.githubusercontent.com/DII-LIH-Luxembourg/cycadas_demo_data/main/data/edgesTable_data.csv"
  ...
  observeEvent(input$btnLoadAnnoData, {
    ...
    th <- read.csv(dataPath$url_thresholds)
    ...
    ## Load metadata
    md <<- read.csv(dataPath$url_metadata)
    md$X <- NULL
    reactVals$md<- md

    ## Load counts table
    ct <<- read.csv(dataPath$url_cluster_counts)
    ct$X <- NULL
    reactVals$counts_table <- ct

    ## Load annotaiton Tree
    df_nodes <- read.csv(dataPath$url_nodes_table)
    df_edges <- read.csv(dataPath$url_edges_table)
